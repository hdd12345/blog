...
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:250px;text-align:center;}\
            .Table{width:249px;height:200px;}\
            .box{margin-left:12px;margin-right:10px;text-align:center;width:224px;height:22px;font-weight:bold;font-size:21px;}\
