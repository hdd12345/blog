...
var calendar = function(calendarId){
    ...
    c.getcalendar = function(year,month){
        ...
        //星期表头
        var str = '<tr><th style="text-align:center;">日</th><th style="text-align:center;">一</th><th style="text-align:center;">二</th><th style="text-align:center;">三</th><th style="text-align:center;">四</th><th style="text-align:center;">五</th><th style="text-align:center;">六</th></tr>';
        //获取上个月在这个月份中存在的最后日期
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:260px;text-align:center;}\
            .Table{width:259px;height:200px;}\
            .box{margin-left:12px;margin-right:10px;text-align:center;width:234px;height:22px;font-weight:bold;font-size:21px;}\
